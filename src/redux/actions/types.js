...
// fetch All shipper delivered orders
export const FETCH_DELIVERED_ORDER_STARTED = "FETCH_DELIVERED_ORDER_STARTED";
export const FETCH_DELIVERED_ORDER_SUCCESS = "FETCH_DELIVERED_ORDER_SUCCESS";
export const FETCH_DELIVERED_ORDER_FAILURE = "FETCH_DELIVERED_ORDER_FAILURE";
