      ...
      <Container className='category-products'>
        ...
        <Row>
          {categoryProducts.map(product => {
            return (
              <Col lg={3} key={product.ProductID.S} className='product-card'>
                <Card>
                  <Card.Img
                  ...
                  <Card.Body className='product-details'>
                    <Card.Title className='product-name'>
                      <Link to={`/product/${product.ProductID.S}`}>{product.Name.S}</Link>
                    </Card.Title>
                    ...
                    <Row>
                      <Col>
                        <i
                          ...
                          onClick={e => {
                            e.preventDefault();
                            addTo(addToCart(product.ProductID.S, user.Email.S));
                          }}
                          title='Add to cart'
                        />
                      </Col>
