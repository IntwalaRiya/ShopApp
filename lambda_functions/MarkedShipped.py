...
def lambda_handler(event, context):
    ...
    try:
        ...
        if 'Items' in order:
            for index in range(len(order['Items'])):
                cart = dynamodb.scan(
                    ...
                    FilterExpression='#Q.Confirmed = :statevalue AND #N = :id',  # Replace 'ColumnName' with your actual attribute name
                ...
                if 'Items' in cart:
                    update_response = cart_table.update_item(
                        ...
                        UpdateExpression='SET OrderState.Confirmed = :products',
        ...
        cart = dynamodb.scan(
            ...
            FilterExpression='#Q.Shipped = :statevalue',  # Replace 'ColumnName' with your actual attribute name
